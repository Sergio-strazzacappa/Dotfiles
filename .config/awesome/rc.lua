...
firefox = "firefox"
google_chrome = "/opt/google/chrome/google-chrome"
...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, beautiful.menu_submenu},
                                    { " Applications", applicationsmenu, beautiful.menu_submenu,
                                    },
                                  }
                        })
